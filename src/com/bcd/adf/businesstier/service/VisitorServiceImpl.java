...
import com.bcd.adf.businesstier.dao.EventDAO;
	...
	public int changeVisitorPassword(Visitor visitor,String oldpassword,String newpassword,String confirmpassword)
	  {
	   ...
	   checkStatus = visitordao.checkPassword(visitor, oldpassword);
	   if(checkStatus==true)
	   {
	    System.out.println("in service method ");
	    try {
			passwordStatus= visitordao.changeVisitorPassword(visitor,oldpassword,newpassword,confirmpassword);
		} catch (ClassNotFoundException e) {
