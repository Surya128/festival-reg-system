...
public class EventDAO {
	...
	public int deleteEvent(int eventId, int sessionId)
		...
		statement = connection.prepareStatement(query.getDeleteEventSessionSignupEventId());
		 
		statement.setInt(1, eventId);
		 
		res=statement.executeUpdate();
		 
		statement = connection.prepareStatement(query.getDeleteEventSessionEventId());
