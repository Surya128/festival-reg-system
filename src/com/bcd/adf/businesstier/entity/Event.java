...
public class Event {
	...
	public String toString() {
		return "Event [eventid=" + eventid + ", name=" + name + ", description=" + description + ", place=" + place
				+ ", duration=" + duration + ", eventtype=" + eventtype + ", seatsavailable=" + seatsavailable
				+ ", sessionId=" + sessionId + ", eventCoordinatorId=" + eventCoordinatorId + ", add=" + add
				+ ", eventSession=" + eventSession + ", visitors=" + visitors + "]";
	}
