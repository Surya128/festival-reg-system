...
public class FERSDbQuery {
	...
	private String deleteEventSessionEventId ="";
	private String deleteEventSessionSignupEventId="";
	...
	public String getDeleteEventSessionEventId() {
		return deleteEventSessionEventId;
	}

	public void setDeleteEventSessionEventId(String deleteEventSessionEventId) {
		this.deleteEventSessionEventId = deleteEventSessionEventId;
	}

	public String getDeleteEventSessionSignupEventId() {
		return deleteEventSessionSignupEventId;
	}

	public void setDeleteEventSessionSignupEventId(String deleteEventSessionSignupEventId) {
		this.deleteEventSessionSignupEventId = deleteEventSessionSignupEventId;
	}
